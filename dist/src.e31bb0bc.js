...
var model = [new _blocks.TitleBlock('Конструктор сайтов на чистом JavaScript', {
  ...
  alt: 'Это картинка'
}), new _blocks.ColumnsBlock(['Приложение на чистом JavaScript, без использования библиотек', 'Построенно по принципу ООП', 'JavaScript - это просто и интересно.'], {
  styles: {
...
new _app.App(_model.model).init(); // const model = [
//   {type: 'title', value: 'Hey there'},
//   {type: 'text', value: 'here is the text'},
//   {type: 'columns', value: [
//     '111',
//     '222',
//     '333',
